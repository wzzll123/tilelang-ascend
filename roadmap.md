...
当前基线为 `111 passed`。TVM 在 Python 3.13 下会产生 parser deprecation warnings；这些
...
- [ ] 实现 duplicate、silu、sigmoid、sin、cos、pow 和 clamp；补齐其它 cast round
...
- [x] ~~当前测试基线：111 passed，覆盖 memory、scheduler、sync、trace、functional
